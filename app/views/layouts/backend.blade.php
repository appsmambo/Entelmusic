				...
				<div class="navbar-default sidebar" role="navigation">
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							@if (Auth::user()->flag)
							<li>
								<a href="{{url('/admin-sorteo')}}"><i class="fa fa-thumbs-o-up fa-fw"></i> Ganadores</a>
							</li>
							@endif
							<li>
								<a href="{{url('/admin-participantes')}}"><i class="fa fa-users fa-fw"></i> Reporte de participantes</a>
							</li>
							<li>
								<a href="{{url('/admin-logout')}}"><i class="fa fa-sign-out fa-fw"></i> Salir</a>
							</li>
							<li>
								<a target="_blank" href="{{url()}}"><i class="fa fa-external-link fa-fw"></i> entelmusic.pe</a>
							</li>
						</ul>
					</div>
					<!-- /.sidebar-collapse -->
