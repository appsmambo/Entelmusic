...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Ver participantes y ganadores</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				Participantes y ganadores por fecha
			</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-sm-8 col-md-7">
						...
						<a href="{{url('/admin-reporte')}}" id="reporte-ganadores" class="btn btn-xl btn-success pull-left" style="display:none;margin-left:6px">VER GANADORES</a>
					</div>
				</div>
				<p>
					&nbsp;
